    ...
    <Text style={styles.prepareText}>
      ...
      clearer audio capture.
          ...
          <Text style={styles.instruction}>
            Listen to the starting note and the
            target interval, then sing the target
            note.
          </Text>

          <Text style={styles.instruction}>
            Try to accurately reproduce the distance
            between the notes.
          </Text>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Listen for how far the target note is
