    ...
    <Text style={styles.prepareText}>
      ...
      clearer audio capture.
          ...
          <Text style={styles.instruction}>
            Sing through the scale one note at a
            time while following the target pitches.
          </Text>

          <Text style={styles.instruction}>
            Try to land accurately on every note
            and avoid drifting away from the target.
          </Text>
          ...
          <Text style={styles.helperText}>
            Focus on accurate note changes rather
            than singing as quickly as possible.
          </Text>
        </View>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Sing each note clearly before moving
            to the next one.
          </Text>
        </View>
