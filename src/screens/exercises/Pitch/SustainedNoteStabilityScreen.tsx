    ...
    <Text style={styles.prepareText}>
      ...
      clearer audio capture.
          ...
          <Text style={styles.instruction}>
            Sing one comfortable note and hold it
            for the duration of the exercise.
          </Text>

          <Text style={styles.instruction}>
            Try to keep the pitch as steady as
            possible without drifting sharp or flat.
          </Text>
          ...
          <Text style={styles.helperText}>
            Maintain a relaxed voice and avoid
            unnecessary pitch movement.
          </Text>
        </View>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Choose a comfortable pitch that you
            can sustain without straining.
          </Text>
        </View>
